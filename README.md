...
## Notes
1. There are two versions, 'novel_scrape.py' which runs in a gui, and 'novel_scrape_console.py' which runs solely in the terminal
...
3. Enter an ending chapter (Default is the latest release)
